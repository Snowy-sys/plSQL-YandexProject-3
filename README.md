...
## Ревью
Результат ревью и отзыв по проекту размещен в [Comments.txt](https://github.com/Snowy-sys/plSQL-YandexProject-3/blob/main/Comments.txt)
...
#### Предусловия
Перед началом выполнения заданий необходимо развернуть базу данных из дампа [practicum_sql_for_dev_project_3](https://github.com/Snowy-sys/plSQL-YandexProject-3/blob/main/practicum_sql_for_dev_project_3.sql). Реализация всех заданий представлена в [СР_3](https://github.com/Snowy-sys/plSQL-YandexProject-3/blob/main/%D0%A1%D0%A0_3.sql)
